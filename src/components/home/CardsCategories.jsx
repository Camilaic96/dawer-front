...
const CardsCategories = () => {
	const cards = [
		{
			...
			image: '../img/categories/vinos-y-bebidas.png',
		...
		},
		{
			...
			image: '../img/categories/frutos-y-cereales.png',
		...
		},
		{
			...
			image: '../img/categories/aceites-y-acetos.png',
		...
		},
		{
			...
			image: '../img/categories/especias-y-condimentos.png',
		...
		},
		{
			...
			image: '../img/categories/dulces-y-encurtidos.png',
		...
		},
		{
			...
			image: '../img/categories/panificados-e-insumos.png',
	...
	return (
		<section id="container-cards-home" className="row">
			{cards.map(card => (
